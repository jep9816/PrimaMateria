//
//  XTRSceneDelegate.swift
//  PrimaMateria PRD
//
//  Created by Jerry Porter on 10/25/19.
//  Copyright ©2020 Jerry Porter. All rights reserved.
//

import UIKit
class XTRSceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window?.rootViewController = XTRAppDelegate.storyboard().instantiateViewController(withIdentifier: XTRMainViewController.nameOfClass) as! XTRMainViewController
