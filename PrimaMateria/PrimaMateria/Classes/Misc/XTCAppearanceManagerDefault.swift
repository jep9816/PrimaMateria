...
class XTCAppearanceManagerDefault : NSObject {
    
    private static var __once: () = { _sharedInstance = XTCAppearanceManagerDefault() }()
    static var _sharedInstance : XTCAppearanceManagerDefault!

    struct Static {
        static var dispatchOnceToken = 0
    }
    
    class func sharedInstance() -> XTCAppearanceManagerDefault {
        _ = XTCAppearanceManagerDefault.__once
